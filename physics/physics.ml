...
(* Pure rigid-body physics: no rendering and no backend dependency, so it can
   be linked in headless programs (e.g. a game server). [Gamelle.Physics]
   re-exports this module and adds the [draw]/[fill] helpers on top. *)
