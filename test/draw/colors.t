...
The clipping scene is exercised separately (see clip_diff.t); every fill left
here is opaque or blended exactly once over the flat background, so the two
backends agree on the whole set exactly:
